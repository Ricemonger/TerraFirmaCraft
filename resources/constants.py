...
DEFAULT_LANG = {
    ...
    **lang_enum('direction', ('north', 'south', 'east', 'west', 'down', 'up')),
    ...
    'tfc.enum.forgingbonus.botched': 'Botched',
    'tfc.enum.forgingbonus.shoddily_forged': 'Shoddily Forged',
    'tfc.enum.forgingbonus.poorly_forged': 'Poorly Forged',
    'tfc.enum.forgingbonus.roughly_forged': 'Roughly Forged',
    'tfc.enum.forgingbonus.plainly_forged': 'Plainly Forged',
